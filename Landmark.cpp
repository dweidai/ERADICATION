...
Landmark::Landmark(glm::vec3 pos, char* texture)
{
	float side = 3.0f;

	float vertices[] = { 
		-side*2,  0.0f, -side,  0.0f, 1.0f,
		side*2,  0.0f, -side,  1.0f, 1.0f,
		side*2,  0.0f,  side,  1.0f, 0.0f,
		side*2,  0.0f,  side,  1.0f, 0.0f,
		-side*2,  0.0f,  side,  0.0f, 0.0f,
		-side*2,  0.0f, -side,  0.0f, 1.0f };
...
void Landmark::draw(GLuint shaderProgram)
{ 
